...
class SDLEvent : public cListener
{
public:
	// Constructor
	SDLEvent();
...
private:
	...
	void InjectMouseButtonEvent		(int iButton,bool bDown);
	void InjectMouseButtonEvent		(int iButton,bool bDown,int iEventX,int iEventY);
};
