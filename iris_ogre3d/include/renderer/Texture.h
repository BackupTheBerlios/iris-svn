...
private:
 ...
 int gltex; // TODO : ghoulsblade : obsolete ?
 bool assigned;
 int width;
 int height;
 int real_width;
...
public:
   ...
   /// generates or retrieves a ogre material  for use by the gui (depthcheck&lighting off), and returns the name
   /// by ghoulsblade
   std::string msImageFile; // unused, just for info
