...
{ PROFILE
  ...
  float t;
	...
	printf("WARNING ! EXTRACT FRUSTUM HAD TO BE DEACTIVATED, DON'T USE !\n");
...
{PROFILE
  int i;
	...
	/// NOTE : ghoulsblade : you might want to take a look at IntersectRayTriangle in ogrewrapper.cpp, found the code on really cool geometry site, should be much faster than this here....
