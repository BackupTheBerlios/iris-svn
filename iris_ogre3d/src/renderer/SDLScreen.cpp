...
#include "profile.h"
typedef float                GLfloat; // todo : usage of this is obsolete....
...
{PROFILE
	...
	// ghoulsblade : replaced by ogre system
	/*
...
{PROFILE
	printf("\n\n\nSDLScreen::Init SHOULDN'T BE CALLED ANYMORE\n\n\n\n");
...
int SDLScreen::InitGL(  )
{PROFILE
	printf("\n\n\nSDLScreen::InitGL SHOULDN'T BE CALLED ANYMORE\n\n\n\n");
	if ( !m_kScreen )
	{
		return false;
	}
