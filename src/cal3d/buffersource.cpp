...
CalBufferSource::CalBufferSource (void *inputBuffer):mInputBuffer (inputBuffer),
mOffset (0)
{
}
...
bool CalBufferSource::readBytes (void *pBuffer, int length)
{
  ...
  bool result =
    CalPlatform::readBytes (((char *) mInputBuffer + mOffset), pBuffer,
                            length);
  mOffset += length;
...
bool CalBufferSource::readFloat (float &value)
{
  ...
  bool result =
    CalPlatform::readFloat (((char *) mInputBuffer + mOffset), value);
  mOffset += 4;
...
bool CalBufferSource::readInteger (int &value)
{
  ...
  bool result =
    CalPlatform::readInteger (((char *) mInputBuffer + mOffset), value);
  mOffset += 4;
...
bool CalBufferSource::readString (std::string & strValue)
{
  ...
  bool result =
    CalPlatform::readString (((char *) mInputBuffer + mOffset), strValue);
