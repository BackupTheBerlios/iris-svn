...
CalCoreMaterial::CalCoreMaterial ():m_userData (0)
{
}
...
void CalCoreMaterial::setAmbientColor (const CalCoreMaterial::
                                       Color & ambientColor)
{
...
void CalCoreMaterial::setDiffuseColor (const CalCoreMaterial::
                                       Color & diffuseColor)
{
...
void CalCoreMaterial::setSpecularColor (const CalCoreMaterial::
                                        Color & specularColor)
{
