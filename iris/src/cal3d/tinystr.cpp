...
//}
unsigned TiXmlString::length () const const 
{
...
unsigned TiXmlString::find (char tofind, unsigned offset) const const 
{
...
} bool TiXmlString::operator == (const TiXmlString & compare) const const 
{
