...
Boolean CalAnimation_Create (CalAnimation * self,
...
Boolean CalAnimationAction_Create (CalAnimationAction * self,
                                   CalCoreAnimation * pCoreAnimation)
{
  return self->create (pCoreAnimation) ? True : False;
}
...
Boolean CalAnimationAction_Execute (CalAnimationAction * self, float delayIn,
                                    float delayOut)
{
...
Boolean CalAnimationCycle_Blend (CalAnimationCycle * self, float weight,
                                 float delay)
{
  return self->blend (weight, delay) ? True : False;
}

Boolean CalAnimationCycle_Create (CalAnimationCycle * self,
                                  CalCoreAnimation * pCoreAnimation)
{
  return self->create (pCoreAnimation) ? True : False;
}
...
void CalAnimationCycle_SetAsync (CalAnimationCycle * self, float time,
                                 float duration)
{
...
void CalBone_BlendState (CalBone * self, float weight,
                         CalVector * pTranslation, CalQuaternion * pRotation)
{
...
Boolean CalCoreAnimation_AddCoreTrack (CalCoreAnimation * self,
...
CalCoreTrack *CalCoreAnimation_GetCoreTrack (CalCoreAnimation * self,
                                             int coreBoneId)
{
...
void CalCoreBone_SetCoreSkeleton (CalCoreBone * self,
...
void CalCoreBone_SetRotationBoneSpace (CalCoreBone * self,
                                       CalQuaternion * pRotation)
{
...
void CalCoreBone_SetTranslationBoneSpace (CalCoreBone * self,
                                          CalVector * pTranslation)
{
...
void CalCoreKeyframe_SetRotation (CalCoreKeyframe * self,
                                  CalQuaternion * pRotation)
{
  self->setRotation (*pRotation);
}
...
void CalCoreKeyframe_SetTranslation (CalCoreKeyframe * self,
                                     CalVector * pTranslation)
{
  self->setTranslation (*pTranslation);
}
...
Boolean CalCoreMaterial_SetMapUserData (CalCoreMaterial * self, int mapId,
...
void CalCoreMaterial_SetUserData (CalCoreMaterial * self,
                                  CalUserData userData)
{
  self->setUserData (userData);
}
...
int CalCoreMesh_AddCoreSubmesh (CalCoreMesh * self,
...
int CalCoreModel_AddCoreAnimation (CalCoreModel * self,
                                   CalCoreAnimation * pCoreAnimation)
{
  return self->addCoreAnimation (pCoreAnimation);
}

int CalCoreModel_AddCoreMaterial (CalCoreModel * self,
...
Boolean CalCoreModel_CreateCoreMaterialThread (CalCoreModel * self,
...
CalCoreAnimation *CalCoreModel_GetCoreAnimation (CalCoreModel * self,
                                                 int coreAnimationId)
{
...
CalCoreMaterial *CalCoreModel_GetCoreMaterial (CalCoreModel * self,
                                               int coreMaterialId)
{
...
int CalCoreModel_GetCoreMaterialId (CalCoreModel * self,
                                    int coreMaterialThreadId,
...
Boolean CalCoreModel_SaveCoreAnimation (CalCoreModel * self,
                                        char *strFilename,
                                        int coreAnimationId)
{
  return self->saveCoreAnimation (strFilename,
                                  coreAnimationId) ? True : False;
}

Boolean CalCoreModel_SaveCoreMaterial (CalCoreModel * self, char *strFilename,
                                       int coreMaterialId)
{
  return self->saveCoreMaterial (strFilename, coreMaterialId) ? True : False;
}

Boolean CalCoreModel_SaveCoreMesh (CalCoreModel * self, char *strFilename,
                                   int coreMeshId)
{
...
Boolean CalCoreModel_SetCoreMaterialId (CalCoreModel * self,
                                        int coreMaterialThreadId,
                                        int coreMaterialSetId,
                                        int coreMaterialId)
{
  return self->setCoreMaterialId (coreMaterialThreadId, coreMaterialSetId,
                                  coreMaterialId) ? True : False;
}

void CalCoreModel_SetCoreSkeleton (CalCoreModel * self,
                                   CalCoreSkeleton * pCoreSkeleton)
{
  self->setCoreSkeleton (pCoreSkeleton);
}
...
int CalCoreSkeleton_AddCoreBone (CalCoreSkeleton * self,
...
CalCoreBone *CalCoreSkeleton_GetCoreBone (CalCoreSkeleton * self,
                                          int coreBoneId)
{
...
Boolean CalCoreSubmesh_Reserve (CalCoreSubmesh * self, int vertexCount,
                                int textureCoordinateCount, int faceCount,
                                int springCount)
{
  return self->reserve (vertexCount, textureCoordinateCount, faceCount,
                        springCount) ? True : False;
}

void CalCoreSubmesh_SetCoreMaterialThreadId (CalCoreSubmesh * self,
                                             int coreMaterialThreadId)
{
...
Boolean CalCoreSubmesh_EnableTangents (struct CalCoreSubmesh * self,
...
Boolean CalCoreTrack_AddCoreKeyframe (CalCoreTrack * self,
...
Boolean CalCoreTrack_GetState (CalCoreTrack * self, float time,
                               CalVector * pTranslation,
                               CalQuaternion * pRotation)
{
...
void CalError_SetLastError (CalErrorCode code, char *strFile, int line,
                            char *strText)
{
...
CalCoreAnimation *CalLoader_LoadCoreAnimation (CalLoader * self,
                                               char *strFilename)
{
  return self->loadCoreAnimation (strFilename);
}

CalCoreMaterial *CalLoader_LoadCoreMaterial (CalLoader * self,
                                             char *strFilename)
{
  return self->loadCoreMaterial (strFilename);
}
...
CalCoreSkeleton *CalLoader_LoadCoreSkeleton (CalLoader * self,
                                             char *strFilename)
{
...
Boolean CalMixer_BlendCycle (CalMixer * self, int id, float weight,
                             float delay)
{
...
Boolean CalMixer_ExecuteAction (CalMixer * self, int id, float delayIn,
                                float delayOut)
{
...
int CalPhysique_CalculateNormals (CalPhysique * self, CalSubmesh * pSubmesh,
                                  float *pNormalBuffer)
{
  return self->calculateNormals (pSubmesh, pNormalBuffer);
}

int CalPhysique_CalculateVertices (CalPhysique * self, CalSubmesh * pSubmesh,
                                   float *pVertexBuffer)
{
  return self->calculateVertices (pSubmesh, pVertexBuffer);
}

int CalPhysique_CalculateVerticesAndNormals (CalPhysique * self,
                                             CalSubmesh * pSubmesh,
                                             float *pVertexBuffer)
{
...
int CalPhysique_CalculateVerticesNormalsAndTexCoords (CalPhysique * self,
                                                      CalSubmesh * pSubmesh,
                                                      float *pVertexBuffer,
                                                      int NumTexCoords)
{
  return self->calculateVerticesNormalsAndTexCoords (pSubmesh, pVertexBuffer,
                                                     NumTexCoords);
}

int CalPhysique_CalculateTangentSpaces (CalPhysique * self,
                                        CalSubmesh * pSubmesh, int mapId,
...
void CalQuaternion_Op_Multiply (CalQuaternion * pResult, CalQuaternion * pQ,
                                CalQuaternion * pR)
{
  *pResult = *pQ * *pR;
}

void CalQuaternion_Set (CalQuaternion * self, float qx, float qy, float qz,
                        float qw)
{
...
void CalRenderer_GetAmbientColor (CalRenderer * self,
                                  unsigned char *pColorBuffer)
{
  self->getAmbientColor (pColorBuffer);
}

void CalRenderer_GetDiffuseColor (CalRenderer * self,
                                  unsigned char *pColorBuffer)
{
...
void CalRenderer_GetSpecularColor (CalRenderer * self,
                                   unsigned char *pColorBuffer)
{
...
int CalRenderer_GetTextureCoordinates (CalRenderer * self, int mapId,
...
int CalRenderer_GetVerticesAndNormals (CalRenderer * self,
                                       float *pVertexBuffer)
{
  return self->getVerticesAndNormals (pVertexBuffer);
}

int CalRenderer_GetVerticesNormalsAndTexCoords (CalRenderer * self,
                                                float *pVertexBuffer,
                                                int NumTexCoords)
{
...
int CalRenderer_GetTangentSpaces (CalRenderer * self, int mapId,
                                  float *pTangentSpaceBuffer)
{
...
Boolean CalRenderer_SelectMeshSubmesh (CalRenderer * self, int meshId,
                                       int submeshId)
{
...
Boolean CalSaver_SaveCoreAnimation (CalSaver * self, char *strFilename,
                                    CalCoreAnimation * pCoreAnimation)
{
  return self->saveCoreAnimation (strFilename, pCoreAnimation) ? True : False;
}

Boolean CalSaver_SaveCoreMaterial (CalSaver * self, char *strFilename,
                                   CalCoreMaterial * pCoreMaterial)
{
  return self->saveCoreMaterial (strFilename, pCoreMaterial) ? True : False;
}

Boolean CalSaver_SaveCoreMesh (CalSaver * self, char *strFilename,
                               CalCoreMesh * pCoreMesh)
{
  return self->saveCoreMesh (strFilename, pCoreMesh) ? True : False;
}

Boolean CalSaver_SaveCoreSkeleton (CalSaver * self, char *strFilename,
                                   CalCoreSkeleton * pCoreSkeleton)
{
...
Boolean CalSkeleton_Create (CalSkeleton * self,
                            CalCoreSkeleton * pCoreSkeleton)
{
...
void CalSpringSystem_CalculateForces (CalSpringSystem * self,
                                      CalSubmesh * pSubmesh, float deltaTime)
{
  self->calculateForces (pSubmesh, deltaTime);
}

void CalSpringSystem_CalculateVertices (CalSpringSystem * self,
                                        CalSubmesh * pSubmesh,
                                        float deltaTime)
{
...
void CalVector_Op_Subtract (CalVector * pResult, CalVector * pV,
                            CalVector * pU)
{
  *pResult = *pV - *pU;
}

void CalVector_CalVector_Op_Scale (CalVector * pResult, CalVector * pV,
                                   float d)
{
  *pResult = *pV * d;
}

void CalVector_CalVector_Op_InverseScale (CalVector * pResult, CalVector * pV,
                                          float d)
{
  *pResult = *pV / d;
}
